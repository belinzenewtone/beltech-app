...
class QuarantineItem {
  const QuarantineItem({required this.candidate, required this.analysis});
  ...
  String get id =>
      '${candidate.mpesaCode}_${candidate.occurredAt.millisecondsSinceEpoch}';
}
...
final quarantineQueueProvider = FutureProvider<List<QuarantineItem>>((
  ref,
) async {
