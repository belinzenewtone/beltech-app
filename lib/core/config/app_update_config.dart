class AppUpdateConfig {
  ...
  static const String latestVersion = String.fromEnvironment(
    'APP_UPDATE_LATEST_VERSION',
  );
  static const String minSupportedVersion = String.fromEnvironment(
    'APP_UPDATE_MIN_VERSION',
  );
  static const String forceUpdateRaw = String.fromEnvironment(
    'APP_UPDATE_FORCE',
  );
  ...
  static const String websiteUrl = String.fromEnvironment(
    'APP_UPDATE_WEBSITE_URL',
  );
  static const String remoteManifestUrl = String.fromEnvironment(
    'APP_UPDATE_REMOTE_MANIFEST_URL',
  );
