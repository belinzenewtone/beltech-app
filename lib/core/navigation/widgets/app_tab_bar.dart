...
class AppTabBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = GlassStyles.barFillFor(brightness);
    final borderColor = GlassStyles.borderFor(brightness);
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          filter: ImageFilter.blur(
            sigmaX: GlassStyles.tabBarBlurSigma,
            sigmaY: GlassStyles.tabBarBlurSigma,
          ),
          child: Container(
