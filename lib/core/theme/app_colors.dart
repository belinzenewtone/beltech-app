...
class AppColors {
  ...
  static const Color backgroundTop = Color(
    0xFF0B0F14,
  ); // RN uses solid background mostly
  ...
  static const Color surfaceAccent = Color(0xFF1D4ED8); // blue-700
  static const Color surfaceAccentStrong = Color(0xFF2563EB); // blue-600
  static const Color surfaceAccentAlt = Color(0xFF172554); // blue-950
  ...
  static const Color borderOnHero = Color(
    0x38A9B4C2,
  ); // rgba(169, 180, 194, 0.22)

  // ── Accent — BLUE (matches Kotlin reference primary color) ───────────────────
  static const Color accent = Color(0xFF3B82F6);
  static const Color accentStrong = Color(0xFF2563EB); // blue-600
  static const Color accentSoft = Color(0x293B82F6); // rgba(59, 130, 246, 0.16)
  ...
  static const Color surfaceSuccess = Color(
    0x1E22C55E,
  ); // rgba(34, 197, 94, 0.12)
  ...
  static const Color glowIndigo = Color(
    0x298B6DFF,
  ); // rgba(139, 109, 255, 0.16)
  ...
  static const Color categoryGrowth = Color(
    0xFF8B6DFF,
  ); // RN categoryColors.growth
  static const Color categoryPersonal = Color(
    0xFF2DCF91,
  ); // RN categoryColors.personal
  ...
  static Color categoryColorFor(String category) {
    return switch (category.toLowerCase()) {
      ...
      'loans' ||
      'loans & credit' ||
      'credit' => const Color(0xFFDC2626), // red-600
