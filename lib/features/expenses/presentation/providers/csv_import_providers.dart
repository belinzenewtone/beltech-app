...
final csvImportPreviewProvider =
    StateProvider<CsvImportPreview?>((_) => null);

final csvImportColumnMappingProvider =
...
final csvImportControllerProvider = AutoDisposeAsyncNotifierProvider<
  CsvImportController,
  int
