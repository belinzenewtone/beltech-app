    ...
    return AbsorbPointer(
      ...
      child: eventsState.when(
        ...
        data: (events) {
          ...
          final visibleEvents = state._showCompletedEvents
              ? sortedEvents
              : sortedEvents
          ...
          if (visibleEvents.isEmpty) {
            return AppEmptyState(
              ...
              title: sortedEvents.isEmpty ? 'No events' : 'No pending events',
              subtitle: sortedEvents.isEmpty
                  ? 'Add an event to get started.'
                  : 'Completed events are hidden. Tap "Show done" to view all.',
            );
          }
