...
class NotificationSettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final learningEnabledState = ref.watch(learningRemindersEnabledProvider);
    final learningTimeState = ref.watch(learningReminderTimeProvider);
    ...
    final learningEnabled = learningEnabledState.value ?? true;
    final (learningHour, learningMinute) =
        learningTimeState.value ?? (8, 0);
    ...
    final readOnly =
        ...
        learningEnabledState.isLoading ||
        learningTimeState.isLoading ||
        ...
        child: Column(
          ...
          children: [
            ...
            SettingsRow(
              ...
              subtitle:
                  'Daily nudge at ${learningHour.toString().padLeft(2, '0')}:${learningMinute.toString().padLeft(2, '0')}',
              trailing: Switch.adaptive(
                ...
                onChanged: childPreferencesReadOnly
                    ...
                    : (value) async {
                        await ref
                            .read(
                              notificationPreferenceControllerProvider.notifier,
                            )
                            .setLearningRemindersEnabled(value);
                      },
              ),
              dividerAbove: true,
            ),
            _DigestTimeRow(
              ...
              enabled: !childPreferencesReadOnly && learningEnabled,
              onTap: () async {
                final picked = await showTimePicker(
                  context: context,
                  initialTime:
