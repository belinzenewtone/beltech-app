...
class _AppDriftSchema {
  static Future<void> ensureInitialized(AppDriftStore store) async {
    ...
    await _AppDriftSchemaMigrations.tryAddMpesaCodeColumn(store);
    ...
    await store._db.runCustom(
      'CREATE UNIQUE INDEX IF NOT EXISTS idx_tx_mpesa_code '
      'ON transactions(mpesa_code) WHERE mpesa_code IS NOT NULL',
    );
    await store._db.runCustom(
