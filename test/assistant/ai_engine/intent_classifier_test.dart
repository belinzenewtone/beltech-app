...
void main() {
  ...
  group('IntentClassifier', () {
    ...
    test('classifies task queries', () {
      expect(
        classifier.classify('Do I have pending tasks?'),
        Intent.taskSummary,
      );
      expect(
        classifier.classify('What should I do today?'),
        Intent.taskSummary,
      );
    });
    ...
    test('classifies health queries', () {
      expect(
        classifier.classify('How is my financial health?'),
        Intent.healthCheck,
      );
    ...
    test('classifies anomaly queries', () {
      ...
      expect(
        classifier.classify('Suspicious transactions'),
        Intent.anomalyAlert,
      );
    });
    ...
    test('classifies cash flow queries', () {
      expect(
        classifier.classify('Project my cash flow'),
        Intent.cashFlowProjection,
      );
      expect(
        classifier.classify('Will I have enough next month?'),
        Intent.cashFlowProjection,
      );
    });
    ...
    test('classifies learning queries', () {
      ...
      expect(
        classifier.classify('How many study days?'),
        Intent.learningSummary,
      );
    });
    ...
    test('classifies advice queries', () {
      ...
      expect(
        classifier.classify('How can I save more?'),
