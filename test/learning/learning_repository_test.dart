...
void main() {
  ...
  test('deleteSession removes session', () async {
    await repository.addSession(topic: 'A', durationMinutes: 30, date: DateTime(2024, 6, 1));
  ...
  test('monthlyMinutes sums current month correctly', () async {
    ...
    await repository.addSession(topic: 'C', durationMinutes: 20, date: DateTime(now.year, now.month - 1, 1));
