...
void main() {
  ...
  test('updateLoan and deleteLoan work correctly', () async {
    ...
    await repository.updateLoan(id: loan.id, outstandingAmount: 15000, status: LoanStatus.cleared);
  ...
  test('totalOutstanding sums active loans only', () async {
    await repository.addLoan(name: 'A', totalAmount: 10000, outstandingAmount: 5000, status: LoanStatus.active);
    await repository.addLoan(name: 'B', totalAmount: 20000, outstandingAmount: 0, status: LoanStatus.cleared);
    await repository.addLoan(name: 'C', totalAmount: 30000, outstandingAmount: 10000, status: LoanStatus.active);
